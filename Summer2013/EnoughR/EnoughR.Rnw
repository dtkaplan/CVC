...
{\bf Process:} Start with the original, immutable data tables.  Transform variables, subset cases, group cases, and join tables as needed to create a single table with the variables you want to display or model. 

\begin{multicols}{4}
\raggedright


\vspace*{-.2in}\subsection*{Sources of Data}
...
\vspace*{-.2in}\subsection*{Simple Data Cleaning}
...
\vspace*{-.2in}\subsection*{Change Type of Variables}
...
\vspace*{-.2in}\subsection*{Mathematical Ops}
