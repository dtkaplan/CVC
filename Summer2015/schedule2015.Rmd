...
### Monday
 ...
 5. [RMarkdown](http://prezi.com/e7wtfnacj9ub/) [Nick]
...
### Wednesday
 ...
 1. More data wrangling with `dplyr` and `tidyr` [Danny]
    a. merging data from multiple sources (joining)
    b. `gather()`
...
### Thursday
  1. Finding R packages and documentation [Randy]
