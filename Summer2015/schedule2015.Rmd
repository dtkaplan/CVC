...
### Tuesday
 ...
 2. The graphics-data interface [Danny/Randy] 
    a. graphing concepts: [slides](Slides/GraphicsBasics/graphics-basics.html)
    b. **Activity:** data <-> graphs
 ...
 4. Working with data -- 5 verbs of `dplyr`
    * Getting your data into the right shape for plotting
...
### Wednesday
 ...
 1. More data wrangling with `dplyr`
