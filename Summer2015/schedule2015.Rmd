...
### Thursday
 ...
 3. Shiny tutorial. [Danny & Randy] The group designed an app to be embedded in an Rmd file.  Here's the [Rmd file](Learn/Shiny/OurDistributionDemo.Rmd).  We deployed the app [here](https://dtkaplan.shinyapps.io/OurDistributionDemo).  Try it out!
