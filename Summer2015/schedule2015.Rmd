...
### Wednesday
 ...
 1. More data wrangling with `dplyr` and `tidyr` 
    a. merging data from multiple sources [Danny]
        [Slides](Learn/Join/joins.html), [bird-species spreadsheet](https://docs.google.com/spreadsheets/d/1GDKeulVSRXL7Q_5Q0a7Offc_IPX2T4sZ80VN5VLASew/edit#gid=0), and the zebrafish treatment [CSV file](Learn/Wrangling/FishTx.csv) 
    b. `gather()` [Randy]
 ...
 3. More `ggplot2` [Randy]
    
 4. Plans for Phase 2
    a. Project Quick Reports
    b. "Breakout" Sessions

 5. Writing Functions [Randy]
