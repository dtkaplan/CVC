...
### Monday
 ...
 5. [RMarkdown](http://prezi.com/vq6l5yqpnqma/) [Nick]
    ...
    * Example: Student evaluations see RMarkdown/student-evals.Rmd in CVCReadOnly/Markdown
...
### Tuesday
 ...
 5. Working with data -- 5 verbs of `dplyr` [Jo]    
    Getting your data into the right shape for graphing or analysis
     ...
     <!-- c. [Sample solution Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2016/Learn/Wrangling/dplyrwrkshtCVCsol.Rmd) [Sample solution html](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2016/Learn/Wrangling/dplyrwrkshtCVCsol.html) -->
...
-->
 ...
 2. Quick Shiny interlude [Example 1 ](https://r.amherst.edu/apps/nhorton/sat/) [Nick]
...
1. Github [Randy]
3. Shiny [Danny, Nick, or Jo] --- [Notes from Danny's Shiny tutorial](Learn/Shiny-breakout/Notes-on-shiny.Rmd)
