 ...
 4. Working with data -- 5 verbs of `dplyr` [Jo]    
    Getting your data into the right shape for graphing or analysis
     ...
     a. [slides](Learn/Wrangling/dplyrCVC.html) for presentation; 
        [markdown file](https://rawgithub.com/dtkaplan/CVC/Summer2016/Learn/Wrangling/dplyrCVC.Rmd) also available
 
     b. [Worksheet](Learn/Wrangling/dplyrwrkshtCVC.html) for presentation; 
       [markdown file](https://rawgithub.com/dtkaplan/CVC/Summer2016/Learn/Wrangling/dplyrwrkshtCVC.Rmd) also available (and on the Calvin server)
