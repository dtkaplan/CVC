...
### Thursday
 ...
 1. Opening (quick) interludes
    ...
    c. Making data available to others via the web
    d. Writing functions in R
      * [Tom, Dick, and Harry](Learn/WritingFunctions/TomDickAndHarry.html)
      * [How to Write Functions](Learn/WritingFunctions/HowToWriteFunctions.html)
 ...
 3. Optional Tutorials
    ...
    b. Maps and Leaflets [Danny] @ 1pm
    c. Linear Modeling [Nick] @ 2:30 pm [Modeling.Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2016/Learn/Modeling/Modeling.Rmd); [Modeling.pdf](Learn/Modeling/Modeling.pdf)
