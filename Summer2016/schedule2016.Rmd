...
### Tuesday
 ...
 2. Introduction to `ggplot2` --  turning the concepts into pictures with the grammar of graphics
 
    a. [slides](Learn/ggplot2/ggplot2Intro.pdf) 
    b. [Dope Sheets](Learn/ggplot2/DopeSheets.pdf) 

 3. Working with data -- 5 verbs of `dplyr` [Jo]    
    Getting your data into the right shape for graphing or analysis
    
 4. Getting your own data into R [Randy]
...
don't be afraid to suggest others.
