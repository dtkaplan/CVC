...
In conrast to (most) *static* data, *dynamic* data...  
...
- Full R Markdown files for downloading: http://research.pomona.edu/johardin/papers-and-publications/  
