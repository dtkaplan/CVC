...
Just from the syntax, you should be able to tell which of the five different kinds of object each of these things is: `Donalds`, `BabyNames`, `filter`, `grepl`, `"Donald"`, `name`, `group_by`, `year`, `summarise`, `total`, `sum`, `count`.
