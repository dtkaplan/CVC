...
I've saved a data set (originally from GapMinder) that has information on HIV prevelance by country over time. 
I've saved the data as an [Rds file]("http://www.calvin.edu/~rpruim/data/HIVdata.Rds"),
