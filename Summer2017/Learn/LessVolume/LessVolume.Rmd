 ...
 * Use arguments of the form `attribute = ~ variable` or terms of the form `attribute:variable` to determine an attribute based on values in a variable

```{r fig.width = 8, fig.height = 3, fig.align = "center", tidy = FALSE, fig.keep = "last"}
