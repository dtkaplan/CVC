...
2. More graphics in R with `ggformula` [Randy and Danny]
 ...
 5. Working with data -- 5 verbs of `dplyr` [Nick]    
    ...
    c. tutorials  
        * [dplyr-movies-tutorial.Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyr-babynames.Rmd) tutorial
        * [dplyr-babynames.Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyr-movies-tutorials.Rmd) tutorial
