...
2. More graphics in R with `ggformula` [Randy and Danny]
 ...
 5. Working with data -- 5 verbs of `dplyr` [Nick]    
    ...
    b. [slides](Learn/Wrangling/dplyr-intro.html) for presentation; [dplyr-babynames.Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyr-babynames.Rmd) tutorial

    c. Useful online resource: downloadable chapter on data wrangling from http://mdsr-book.github.io/
