...
### Monday
 ...
 1. Welcome (9am)
    a. Welcome to CVC/Macalester [Kelly]
 ...
 5. [RMarkdown](http://prezi.com/vq6l5yqpnqma/) [Nick]
    ...
    * Example: [R Markdown example](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/RMarkdown/student-evals.Rmd); [R Markdown formatted](Learn/RMarkdown/student-evals.pdf) (Student evaluations example from Open Intro)
...
### Tuesday
 ...
 2. More graphics in R with `ggformula` and `ggplot2`
 ...
 4. R parts of speech and "Chainging Syntax" [Danny].   [slides](Learn/Parts_of_speech/R-command-structure.html)
 
 5. Working with data -- 5 verbs of `dplyr` []    
    Getting your data into the right shape for graphing or analysis
     ...
     c. [Sample solution Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyrwrkshtCVCsol.Rmd) and [Sample solution html](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyrwrkshtCVCsol.html)
...
1. Github [Randy]
2. learnr []
3. Shiny [] --- [Notes](Learn/Shiny-breakout/readme.html)
...
15. Linear models with "Less Volume, More Creativity" [Nick]
