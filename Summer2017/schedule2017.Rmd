...
responses.  Feel free to edit it at anytime before, during, or (shortly) after the workshop.
  ...
  * [Google Doc](https://docs.google.com/document/d/1a8HOx_FzIQGI39ITW7ACXztcuQ7l8Hdf8KMVBpiaWGs/edit#)
...
<!-- * This was a demo by Jo in 2016 -->
 ...
 5. [RMarkdown](http://prezi.com/vq6l5yqpnqma/) [Nick]
    ...
    c. Example: [R Markdown example](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/RMarkdown/student-evals.Rmd); [R Markdown formatted](Learn/RMarkdown/student-evals.pdf) (Student evaluations example from Open Intro)

    d. **Activity**: Write and publish a description of some 
...
-->
 ...
 7. Homework: Think about your project [Nick]
...
2. More graphics in R with `ggformula` [Randy and Danny]
    ...
    a. The graphics-data interface 
        ...
        * Eye Training: 
        [[web]](https://dtkaplan.github.io/comp110/Presentations/333-eye-training-for-graphics.html)
        [[pdf]](Learn/VizConcepts/eye-training.pdf)
 ...
 5. Working with data -- 5 verbs of `dplyr` [Miles]    
    a. Goal: Get your data into the right shape for graphing or analysis
 
    b. [slides](Learn/Wrangling/dplyrCVC.html) for presentation; 
        <!-- [markdown file](Learn/Wrangling/dplyrCVC.Rmd) also available -->
 
    c. [Worksheet](Learn/Wrangling/dplyrwrkshtCVC.html) for presentation; 
       [markdown file](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyrwrkshtCVC.Rmd) also available (and on the Calvin server)

    d. [Sample solution Rmd](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyrwrkshtCVCsol.Rmd) and [Sample solution html](https://rawgit.com/dtkaplan/CVC/gh-pages/Summer2017/Learn/Wrangling/dplyrwrkshtCVCsol.html)
