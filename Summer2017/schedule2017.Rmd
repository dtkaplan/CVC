...
### Wednesday
 ...
 1. More data wrangling with `dplyr` and `tidyr` [Randy] 
    ...
    b. A data tidying case study: [tidydata-TB-tutorial.Rmd](Learn/Wrangling/tidydata-TB-tutorial.Rmd)
...
[Shiny resources](http://shiny.rstudio.com) [Nick]
    ...
    d. Leaflets ([leaflet.Rmd](XX), see also https://rstudio.github.io/leaflet) [Nick]
